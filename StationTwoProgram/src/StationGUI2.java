...
public class StationGUI2 extends JFrame {
	...
	public static void main(String[] args) {
		...
		try {
			StationGUI2 frame = new StationGUI2();
	 ...
	 * Create the frame.
	 */
	public StationGUI2() {//gui allll gui
	...
	public static void stationTwoActivator() throws Exception{
